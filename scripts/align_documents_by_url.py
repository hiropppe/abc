...
def match_url(l1_url, l2_url):
    ...
    # Allow same URLs to be aligned
    if l1_path_query == l2_path_query or re_del.sub("", re_sla2.sub("/", re_l1_lang.sub("", l1_path_query))) == re_del.sub("", re_sla2.sub("/", re_l2_lang.sub("", l2_path_query))):
        return True
    else:
        return False
